...
async function installOhMyZsh() {
  ...
  try {
    echo(chalk.blue('\ninstall oh-my-zsh...'))
    await promisifyExec(`sh -c "$(curl -fsSL https://raw.githubusercontent.com/robbyrussell/oh-my-zsh/master/tools/install.sh)"`)
...
async function addZshPlugins() {
  ...
  await promisifyExec(`git clone https://github.com/zsh-users/zsh-autosuggestions ~/.zsh/zsh-autosuggestions`)
  await promisifyExec(`echo "source ~/.zsh/zsh-autosuggestions/zsh-autosuggestions.zsh" >> ~/.zshrc`)

  // install the plugin for zsh-syntax-highlighting
  echo(chalk.blue('\nadd plugin zsh-syntax-highlighting...'))
  await promisifyExec(`git clone https://github.com/zsh-users/zsh-syntax-highlighting.git ~/.oh-my-zsh/custom/plugins/zsh-syntax-highlighting`)
  await promisifyExec(`echo "source ~/.oh-my-zsh/custom/plugins/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh" >> ~/.zshrc`)
}
...
async function oneByOneByType(type) {
